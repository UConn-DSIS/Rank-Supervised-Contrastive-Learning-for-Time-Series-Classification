...
def load_UCR(dataset,use_fft=False):
    train_file = os.path.join('/home/qir21001/AAAI2022/UCR', dataset, dataset + "_TRAIN.tsv")
    test_file = os.path.join('/home/qir21001/AAAI2022/UCR', dataset, dataset + "_TEST.tsv")
