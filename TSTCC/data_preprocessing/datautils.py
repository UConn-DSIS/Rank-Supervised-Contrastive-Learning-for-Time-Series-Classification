...
def load_UEA(dataset):
    train_data = loadarff(f'/home/qir21001/TS2VEC/UEA/{dataset}/{dataset}_TRAIN.arff')[0]
    test_data = loadarff(f'/home/qir21001/TS2VEC/UEA/{dataset}/{dataset}_TEST.arff')[0]
