...
def load_UEA_dataset(path, dataset):
    ...
    for j in range(nb_dims):
        ...
        # but with a limited impact on the rrted results on few datasets.
...
if __name__ == '__main__':
    ...
    logs_save_dir = '/home/qir21001/nips2019/results'
    experiment_log_dir = os.path.join('/home/qir21001/nips2019/',logs_save_dir, args.dataset)
...
# Logging
    ...
    print("Test accuracy: \n" +"Test AUC: "+ str(classifier.score(test, test_labels)))
    logger.debug('results :ACC,Precision,F1:'+ args.dataset+str(classifier.score(test, test_labels)))
